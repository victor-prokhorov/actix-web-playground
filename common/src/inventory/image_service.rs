...
pub mod image_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn upload_image(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("image_service.ImageService", "UploadImage"));
...
pub mod image_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/image_service.ImageService/UploadImage" => {
                    ...
                    struct UploadImageSvc<T: ImageService>(pub Arc<T>);
                    impl<
                        T: ImageService,
                    ...
                    for UploadImageSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ImageService>::upload_image(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "image_service.ImageService";

...
pub struct GetStockResponse {
    ...
    pub stocks: ::prost::alloc::vec::Vec<ProductStock>,
}
...
pub mod inventory_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("inventory.InventoryService", "GetStock"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod inventory_service_server {
    ...
    pub const SERVICE_NAME: &str = "inventory.InventoryService";
